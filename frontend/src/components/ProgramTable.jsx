...
const ProgramTable = ({ setToastMessage }) => {
  ...
  const handleEditClick = (program) => {
    ...
    const dept = departments.find(d => d.department_name === program.department_name);
  ...
  const handleDeleteClick = (program) => {
    ...
    setActionToConfirm(() => () => deleteProgram(program.program_id, program.program_name));
  ...
  const handleUpdateClick = (e) => {
    ...
    const originalDept = departments.find(d => d.department_name === editingProgram.department_name);
            ...
            {programs.length > 0 ? (
              ...
              programs.map((program) => (
                ...
                >
                  ...
                  <div className="break-words pr-6">{program.department_name}</div>

                  <div className="break-words pr-6">{program.modified_by || "N/A"}</div>
