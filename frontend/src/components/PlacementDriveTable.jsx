            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full md:col-span-2 p-3 border rounded-lg resize-y overflow-y-auto min-h-[120px] max-h-[36vh]"
                />
                <div className="w-full md:col-span-2">
                  ...
                  {showEditModal && editingDrive?.jd_file && (
                    <p className="text-xs text-gray-500 mt-1">
                      Current file: 
                      <a href={`/uploads/placement_drive_files/${editingDrive.jd_file}`} 
